...
public class SubscriptionPackageController {
	...
	public List<SubscriptionPackageCollection> getSubscriptionList(@RequestParam(required = true) Long operatorId) {
		log.debug("Get Request to view Subscription List");
		return spServices.getPackageList(operatorId);
	}
	
	@GetMapping("/packages/{packageId}")
	public SubscriptionPackage getSubscriptionDetails(@PathVariable(required = true) Long packageId) {
	...
	public SubscriptionPackage updateSubscription(@RequestBody SubscriptionPackageRequest spRequest,@PathVariable(required = true) Long packageId) {
		log.debug("Add Subscription  Details");
		return spServices.updatePackage(spRequest, packageId);
	}
	
	@DeleteMapping("/subscriptions/{packageId}")
	public ServiceResponse deleteSubscription(@PathVariable(required = true) Long packageId) {
		log.debug("Add Subscription  Details");
